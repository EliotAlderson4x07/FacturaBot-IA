...
const GEMINI_API_KEY = "AQ.Ab8RN6IzysSmYXWi2_Rip4YuSCX8fRSeKwCgvVyuFKrEhMhipw";
...
const els = {
  ...
  faqWidget: null, // celeste sphere removed
...
function initFaqWidget() {
  const widget = els.faqWidget; // may be null after celeste removal
  ...
  // celeste sphere removed: widget may be null, but keep modal close logic
